...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'adelnriwizard'
BUILDERNAME = 'adelnri'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'https://adelrahmani.com/kodibuild/Wizard/builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Grindhouse[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
REPOID = 'repository.MFinGrindhouse19'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = 'MFinGrindhouse19'
